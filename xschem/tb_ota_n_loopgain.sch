...
N -460 570 -460 590 {
lab=ctrl_mode[0]}
N 390 -210 470 -210 {lab=Vout}
N 470 -210 470 -180 {lab=Vout}
N 470 -180 470 -140 {lab=Vout}
...
C {devices/vsource.sym} -550 620 0 0 {name=VCD1 value=0}
C {devices/gnd.sym} -550 650 0 0 {name=l13 lab=GND}
C {devices/lab_pin.sym} -550 570 3 1 {name=p15 sig_type=std_logic lab=ctrl_mode[1]}
...
.endc
"}
C {devices/lab_pin.sym} 470 -210 0 1 {name=p10 sig_type=std_logic lab=Vout}
...
C {devices/vsource.sym} -460 620 0 0 {name=VCD0 value=1.8}
C {devices/gnd.sym} -460 650 0 0 {name=l7 lab=GND}
C {devices/lab_pin.sym} -460 570 3 1 {name=p16 sig_type=std_logic lab=ctrl_mode[0]}
